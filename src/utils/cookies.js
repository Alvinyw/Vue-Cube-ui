...
const firstLoginPsw = 'firstLoginPsw' // 首次登陆修改密码用
...
export function getFirstLoginPsw() {
  return (Cookies.get(firstLoginPsw))
}
export function setFirstLoginPsw(val) {
  return Cookies.set(firstLoginPsw, val)
}
export function removeFirstLoginPsw() {
